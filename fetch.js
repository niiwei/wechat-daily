...
// 分类规则 - 基于关键词匹配（顺序即优先级，先匹配先得）
const CATEGORY_RULES = [
  {
    // 融资/快讯优先拦截，避免被其他规则误命中
    name: '商业科技快讯',
    keywords: [
      '8点1氪', '极客早知道', '早报', '晚报', '今日快讯',
      '氪早知道', '速览', '快看', '中本聪', '比特币之父',
      '融资', '完成超', '完成近', '亿元', '亿美元', '万美元',
      'Pre-A', 'A轮', 'B轮', 'C轮', 'D轮', '种子轮', 'IPO',
      '早起看早期', '估值', '裁员', 'GoPro', '抄袭', '白银', '机车'
    ]
  },
  {
    name: 'AI前沿资讯',
    keywords: [
      'GPT', 'Claude', 'OpenAI', 'Anthropic', '大模型', 'LLM', 'DeepSeek',
      'Gemini', 'Grok', 'Llama', 'Qwen', 'GLM', 'Sora', 'Muse',
      '模型发布', '模型升级', '专家模式', '多模态', '推理模型',
      'AI公司', 'AI数字人', '基础模型', '预训练',
      'AI能', 'AI写', 'AI为什么', 'AI时代', 'AI浪潮', 'AI局限',
      '人机', '暴论', '最小知识', '非技术人', '原型到上线', 'AI能写诗',
      'AI与人', '具身智能', '机器人'
    ]
  },
  {
    name: 'AI产品与工具',
    keywords: [
      'AI产品', 'Agent', '智能体', 'Skill', 'AI应用', '可灵',
      'TOKEN', 'token', 'AI工具', 'AI提效', 'AI编程', 'AI写作',
      'Copilot', 'Cursor', 'Vibe Coding', '提示词', 'prompt',
      'AI助手', 'AI客服', 'AI搜索', 'RAG', '向量', '封装', '炼化',
      '浏览器', '开源', 'GitHub', '开发者', '代码', '技术工具',
      '框架', '传感器', '算法', '架构'
    ]
  },
  {
    name: '产品经理学习',
    keywords: [
      '产品经理', '产品方法论', '需求', '用户研究', '产品设计',
      '交互', '用户体验', 'UX', 'PRD', '原型', '迭代', '产品思维',
      '产品人', '产品运营', '增长', '留存', '转化', '漏斗'
    ]
  },
  {
    name: '商业洞察',
    keywords: [
      '企业', '商业', '行业', '职场', '年薪', '月薪', '招聘', '红利',
      '战略', '小米', '蒙牛', '马云', '微软', '阿里', '腾讯', '字节',
      '百度', '华为', '电商', '零售', '品牌', '出海', '重构',
      '组织', '调整', '独家'
    ]
  }
];
